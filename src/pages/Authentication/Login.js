...
export default function QuizLoginPage() {
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      setIdCard(file.name); // store file name or file object as needed
    }
  };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        {/* Blue triangle */}
        <div className="absolute bottom-0 left-0 w-full h-full  shadow-2xl" style={{
        ...
        <div className="relative z-10 flex flex-col items-center pt-16 w-full">
          ...
          <div className="bg-white shadow-2xl rounded-lg p-8 w-full max-w-md">
            <h2 className="text-subtitle text-softblue text-center mb-4">
              Login
            </h2>
            
            <p className="text-center text-softblue mb-8">
              You must choose your <span className="font-semibold text-oceanblue">role</span> and insert your <span className="font-semibold text-oceanblue">ID card</span> so you can access the online quizzes platform!
            </p>
            ...
            <div className="flex justify-center">
              <button className="px-6 py-3 bg-transparent hover:bg-softblue/15 text-softblue rounded-md hover:bg-opacity-90 transition-colors border-softblue border-solid border-[1px] ">
                Login Now
              </button>
            </div>
          </div>
